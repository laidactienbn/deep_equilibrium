...
measurement_process = OperatorPlusPoissonNoise(forward_operator, noise_sigma).to(device=device)
...
# Do train
test.test_one_epoch(
                               single_iterate_solver=solver, test_dataloader=test_dataloader,
                               ...
                               use_dataparallel=False, device=device, scheduler=scheduler,
                               print_every_n_steps=print_every_n_steps, save_every_n_epochs=save_every_n_epochs,
                               start_epoch=start_epoch, forward_operator = forward_operator, noise_sigma=1e-2,
                               precond_iterates=60)
